...
var (
	flagWinSvcName      = flag.String("win-service-name", "catpaw", "Set windows service name")
	flagWinSvcDesc      = flag.String("win-service-desc", "catpaw is a monitoring tool", "Set windows service description")
